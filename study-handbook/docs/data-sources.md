...
当前“朗读”优先使用有道词典的在线 MP3 接口，国内网络可一次取得完整单词或词组的音频，不下载或提交音频文件。页面会明确标记“国内快速音源”，并链接至对应词条页；这不是教材官方录音，也不是开源音频。在线音源无法播放时，才回退到设备浏览器的英文语音合成。教材官方音频在获得可公开使用的音频文件或官方授权链接后，再以单词的 `audioUrl` 字段接入；不要把来源不明的音频上传到仓库。
